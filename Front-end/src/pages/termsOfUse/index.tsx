...
const TermsOfUse = () => {
  return (
    <>    
      <Head>
          <title>Terms Of Use | Kampler Store</title>
      ...
      <MainContent>
        <article className="terms__of__use">
          <h2>Website Terms of Use</h2>

          <p>The Kampler Store website located at https://store-ffxi.vercel.app is a copyrighted work belonging to Kampler Store. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
          ...
          <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Rua da Bomba, Queimadas, Bahia. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
          ...
          <p>Address: Rua da Bomba, Queimadas, Bahia</p>
          <p>Email: kampler.store@gmail.com</p>
        </article>
      </MainContent>
    </>
  )
